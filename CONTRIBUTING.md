...
Thank you for improving **Embodied-DataOps**.
...
- documentation and schema checks currently available
- future implementation changes must add tests before claiming completion
